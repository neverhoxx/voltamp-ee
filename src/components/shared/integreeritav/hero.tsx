...
import en from '@/locales/integreeritav/en.json';
import lv from '@/locales/integreeritav/lv.json';
import et from '@/locales/integreeritav/et.json';

import heroImg from '@/images/bgs/integreeritav-bg.jpg';

import { SunMedium } from "lucide-react";

interface IntegreeritavHeroProps {
    params: { locale: string };
}

export default function IntegreeritavHero({ params }: IntegreeritavHeroProps) {
    const { locale } = params;
            ...
            <Container className="overflow-hidden pt-[114px] text-white flex flex-col justify-end  min-h-screen">
                <div className="md:w-[70%] w-full täiskatuse-hero bg-[rgba(0,0,0,0.2)] p-5 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-sm rounded-2xl">
                    ...
                    <h1 className="text-3xl font-bold leading-tight sm:text-5xl">
                        <span className="text-def">{t.heroTitleSpan}</span>
                    </h1>
