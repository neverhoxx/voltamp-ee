...
export default function PildigaleriiHero({ params }: PildigaleriiHeroProps) {
    const { locale } = params;
    ...
    return (
        ...
        >
            <Container className="flex flex-col justify-end min-h-screen pt-[114px]">
                <div className="w-1/2 miks-valida-hero bg-[rgba(0,0,0,0.2)] flex flex-col  p-5 pb-15 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-sm">
